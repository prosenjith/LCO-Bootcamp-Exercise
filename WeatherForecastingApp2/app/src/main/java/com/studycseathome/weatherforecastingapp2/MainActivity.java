...
public class MainActivity extends AppCompatActivity {
    ...
    void getCurrentData() {
        ...
        Call<ForecastResponse> call = service.getCurrentWeatherData(latitude,longitude,cnt, AppId);
            ...
            public void onResponse(@NonNull Call<ForecastResponse> call, @NonNull Response<ForecastResponse> response) {
                if (response.code() == 200) {
                    ...
                    String result = "City: " +
                            ...
                            "\n" +
                            "Country: " +
                            forecastResponse.getCity().getCountry() +
                            "\n" +
                            "Timezone: " +
                            forecastResponse.getCity().getTimezone();
